...
services:
  qbittorrent:
    image: "11notes/qbittorrent:5.2.1"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [5.2.1](https://hub.docker.com/r/11notes/qbittorrent/tags?name=5.2.1)
* [5.2.1-unraid](https://hub.docker.com/r/11notes/qbittorrent/tags?name=5.2.1-unraid)
* [5.2.1-nobody](https://hub.docker.com/r/11notes/qbittorrent/tags?name=5.2.1-nobody)
...
# REGISTRIES ☁️
```
docker pull 11notes/qbittorrent:5.2.1
docker pull ghcr.io/11notes/qbittorrent:5.2.1
docker pull quay.io/11notes/qbittorrent:5.2.1
```
...
*created 27.05.2026, 06:18:49 (CET)*